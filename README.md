...
> Status: v0.7.4 observe-first. Codex multi-agent APIs are evolving; RouteCraft is capability-aware and fails conservatively when a requested model/effort lane or benchmark isolation boundary cannot be selected and verified.
